...
class _mobileState extends State<mobile> {
  ...
  Future<String> country() async {
    final res = await http.get(
        Uri.parse(Apiconst.baseurl+"android/recharge/providers"+Apiconst.token+'type=mobile'));
                  ...
                  children: [
                    ...
                    Row(
                      children:[
                        RaisedButton(
                          ...
                          child: Text('Get Plans',style: TextStyle(
                              fontFamily: "Windsor",
                              color: kBlueColor),),
                    ...
                    ButtonTheme(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          print('jjjjjjjjj');
                          print(harsh.toString());
                          harsh==null?
                          recharge(_phoneController.text, _rechargeController.text,_txnController.text):
                          recharge(_phoneController.text, harsh,_txnController.text);
                        },
                      ),
                    ),
                  ],
  ...
  recharge(String phone, String recharge,String txn)async {
    ...
    if (data['status'] != "ERR") {
      ...
      _rechargependingBottomSheet(context);
...
void _rechargependingBottomSheet(context){
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        Text('Recharge Processing',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                      ],
                    ),
                  ...
                  child: Center(
                    child: Column(
                      children: [
                        ...
                        Text('Somthing went wrong',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
                      ],
                    ),
