...
class Apiconst{
  static const String baseurl='https://deshampay.co.in/admin/api/';
  static const String token='?token=hoV1iUTGDDxZnRg0Ycjnv5jVfRQ1l6&';
  static const String baseurl2='https://deshampay.co.in/admin/';
}
