...
class electrycity_history extends StatefulWidget {
  const electrycity_history({Key? key}) : super(key: key);

  @override
  State<electrycity_history> createState() => _electrycity_historyState();
}

class _electrycity_historyState extends State<electrycity_history> {
  @override
...
Future<List<AddM>> add() async{
  ...
  final response = await http.post(
    Uri.parse(Apiconst.baseurl+'android/transaction?'+"apptoken=$value2&user_id=$value&type=rechvrgestatement"),
